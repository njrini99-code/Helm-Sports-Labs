          ...
          <section className="relative overflow-hidden rounded-3xl">
            ...
            <div className="absolute inset-0">
              {team.banner_url ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-blue-900/30 via-purple-900/20 to-emerald-900/20"></div>
)}
              <div className="absolute inset-0 bg-gradient-to-t from-[#0b1720] via-[#0b1720]/80 to-transparent"></div>
              <div 
