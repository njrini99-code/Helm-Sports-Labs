...
DROP POLICY IF EXISTS "Users can view their team's schedule" ON team_schedule;
...
DROP POLICY IF EXISTS "Coaches can manage their team's schedule" ON team_schedule;
...
DROP POLICY IF EXISTS "Users can view their team's media" ON team_media;
...
DROP POLICY IF EXISTS "Coaches can manage their team's media" ON team_media;
