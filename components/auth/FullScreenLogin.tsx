        ...
        <div className={cn(glassPanelEnhanced, "p-8 sm:p-10 relative overflow-hidden")}>
          ...
          >
            <div className="relative mb-4">
              ...
              <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-[#16893B]/60 animate-ping"></div>
              <div className="absolute -top-2 -left-2 w-8 h-8 rounded-full bg-[#16893B]/40 blur-xl animate-pulse"></div>
            </div>
