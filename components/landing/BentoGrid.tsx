  ...
  className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6 auto-rows-auto">
          ...
          <Card3D intensity={10} className="col-span-1 md:col-span-6 lg:col-span-8 row-span-2">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></motion.div>
          ...
          <Card3D intensity={8} className="col-span-1 md:col-span-3 lg:col-span-4">
            ...
            >
            <div className="absolute inset-0 bg-gradient-to-br from-teal-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></motion.div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-teal-500 border-2 border-white/30 shadow-lg">
                      <div className="absolute inset-0 rounded-full bg-teal-500/50 animate-ping"></motion.div>
                    </motion.div>
                    {/* Connected nodes */}
                    {[
                      { top: '10%', left: '20%' },
                      ...
                      <div key={i} className="absolute" style={pos}>
                        <div className="w-8 h-8 rounded-full bg-emerald-400/60 border border-white/20"></motion.div>
                      </motion.div>
                    ))}
                  </motion.div>
                </motion.div>
